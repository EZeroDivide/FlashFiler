...
type
  ...
  private
    ...
    procedure _BooleanLiteral(Parent: TFFSqlNode;
    ...
    procedure _WhenClause(Parent: TFFSqlNode; var WhenClause: TFFSqlWhenClause);
    ...
    procedure _ScalarFunction(Parent: TFFSqlNode; var Func: TFFSqlScalarFunc);
    procedure _Param(Parent: TFFSqlNode; var Param: TFFSqlParam);
    procedure _Literal(Parent: TFFSqlNode; var Literal: TFFSqlLiteral);
    procedure _Factor(Parent: TFFSqlNode; var Factor: TFFSqlFactor;
      MulOp: TFFSqlMulOp);
    procedure _Term(Parent: TFFSqlNode; var Term: TFFSqlTerm;
      AddOp: TFFSqlAddOp);
    procedure _SimpleExpressionList(Parent: TFFSqlNode;
      var SimpleExpressionList: TFFSqlSimpleExpressionList);
    procedure _IsTest(Parent: TFFSqlNode; var IsTest: TFFSqlIsTest);
    procedure _MatchClause(Parent: TFFSqlNode;
      var MatchClause: TFFSqlMatchClause);
    procedure _InClause(Parent: TFFSqlNode; var InClause: TFFSqlInClause;
      Negated: boolean);
    procedure _LikeClause(Parent: TFFSqlNode; var LikeClause: TFFSqlLikeClause;
      Negated: boolean);
    procedure _BetweenClause(Parent: TFFSqlNode;
      var BetweenClause: TFFSqlBetweenClause; Negated: boolean);
    procedure _AllOrAnyClause(Parent: TFFSqlNode;
      var AllOrAny: TFFSqlAllOrAnyClause);
    procedure _UniqueClause(Parent: TFFSqlNode; var Unique: TFFSqlUniqueClause);
    procedure _ExistsClause(Parent: TFFSqlNode; var Exists: TFFSqlExistsClause);
    procedure _CondPrimary(Parent: TFFSqlNode;
      var CondPrimary: TFFSqlCondPrimary);
    procedure _CondFactor(Parent: TFFSqlNode; var CondFactor: TFFSqlCondFactor);
    procedure _CondTerm(Parent: TFFSqlNode; var CondTerm: TFFSqlCondTerm);
    procedure _GroupColumn(Parent: TFFSqlNode; var Col: TFFSqlGroupColumn);
    ...
    procedure _Column(Parent: TFFSqlNode; var Col: TFFSqlColumn);
    ...
    procedure _OrderItem(Parent: TFFSqlNode; var OrderItem: TFFSqlOrderItem);
    procedure _UpdateItem(Parent: TFFSqlNode; var UpdateItem: TFFSqlUpdateItem);
    procedure _UpdateList(Parent: TFFSqlNode; var UpdateList: TFFSqlUpdateList);
    ...
    procedure _ValueItem(Parent: TFFSqlNode; var ValueItem: TFFSqlValueItem);
    procedure _InsertItem(Parent: TFFSqlNode; var InsertItem: TFFSqlInsertItem);
    procedure _ValueList(Parent: TFFSqlNode; var ValueList: TFFSqlValueList);
    procedure _TableConstructor(Parent: TFFSqlNode;
      var ValueList: TFFSqlValueList);
    procedure _NonJoinTablePrimary(Parent: TFFSqlNode;
      var NonJoinTablePrimary: TffSqlNonJoinTablePrimary);
    procedure _NonJoinTableTerm(Parent: TFFSqlNode;
      var NonJoinTableTerm: TffSqlNonJoinTableTerm);
    procedure _UsingItem(Parent: TFFSqlNode; var UsingItem: TFFSqlUsingItem);
    procedure _UsingList(Parent: TFFSqlNode; var UsingList: TFFSqlUsingList);
    procedure _TableRef(Parent: TFFSqlNode; var TableRef: TffSqlTableRef);
    procedure _NonJoinTableExp(Parent: TFFSqlNode;
      var NonJoinTableExp: TffSqlNonJoinTableExp);
    procedure _JoinTableExp(Parent: TFFSqlNode;
      const JoinTableExp: TffSqlJoinTableExp);
    procedure _SimpleTableRefOrParenTableExp(Parent: TFFSqlNode;
    ...
    procedure _OrderList(Parent: TFFSqlNode; var OrderList: TFFSqlOrderList);
    procedure _GroupColumnList(Parent: TFFSqlNode;
      var ColumnList: TFFSqlGroupColumnList);
    procedure _CondExp(Parent: TFFSqlNode; var CondExp: TFFSqlCondExp);
    procedure _TableRefList(Parent: TFFSqlNode;
      var TableRefList: TFFSqlTableRefList);
    procedure _SelectionList(Parent: TFFSqlSELECT;
      var SelectionList: TFFSqlSelectionList);
    procedure _SelectStatement(Parent: TFFSqlNode; var Select: TFFSqlSELECT);
    procedure _DeleteStatement(Parent: TFFSqlNode; var DeleteSt: TFFSqlDELETE);
    procedure _UpdateStatement(Parent: TFFSqlNode; var UpdateSt: TFFSqlUPDATE);
    procedure _InsertStatement(Parent: TFFSqlNode; var InsertSt: TFFSqlINSERT);
  ...
  public
    ...
    function ErrorStr(const ErrorCode: integer; const Data: String)
      : String; override;
    procedure Execute;
  ...
  public
    ...
    property AllowReservedWordNames: boolean read FAllowReservedWordNames
      write FAllowReservedWordNames;
...
const
  ...
  CHAR_underscoreLENGTHSym = 81;
  COALESCESym = 82;
  CURRENT_underscoreDATESym = 83;
  CURRENT_underscoreTIMESym = 84;
  CURRENT_underscoreTIMESTAMPSym = 85;
  CURRENT_underscoreUSERSym = 86;
  USERSym = 87;
  LOWERSym = 88;
  UPPERSym = 89;
  POSITIONSym = 90;
  SESSION_underscoreUSERSym = 91;
  SUBSTRINGSym = 92;
  FORSym = 93;
  SYSTEM_underscoreUSERSym = 94;
  TRIMSym = 95;
  LEADINGSym = 96;
  TRAILINGSym = 97;
  BOTHSym = 98;
...
begin
  ...
  if NOT FAllowReservedWordNames AND FReservedWordList.Find
    (UpperCase(Result), Idx) then
    SemError(203, Result);
end;
...
begin
  ...
  try
    if not Matches(_lparenSym) then
      exit;
    if not Matches(identSym) and not Matches(SQLNameStringSym) then
      exit;
...
begin
  ...
  try
    if not Matches(_lparenSym) then
      exit;
    if not IsParenNonJoinTableExp and
      not(fCurrentInputSymbol in [SELECTSym, TABLESym, VALUESSym]) then
      exit;
    Result := TRUE;
  finally
    GotoBookmark(BS);
...
begin
  Result := False;
  if (fCurrentInputSymbol = identSym) OR (fCurrentInputSymbol = SQLNameStringSym)
  then
  begin
    Get;
...
begin
  ...
  try
    ...
    if not IsTableRef then
      exit;
    if not(fCurrentInputSymbol in [CROSSSym, NATURALSym, INNERSym, LEFTSym,
      RIGHTSym, FULLSym, UNIONSym, JOINSym]) then
      exit;
    Result := TRUE;
  finally
    GotoBookmark(BS);
...
begin
  Result := (Ch = ' ') OR ((CurrInputCh >= CHR(1)) AND (CurrInputCh <= ' '));
end; { CharInIgnoreSet }
...
begin { Get }
  while CharInIgnoreSet(CurrInputCh) do
    NextCh;
  if ((CurrInputCh = '/') OR (CurrInputCh = '-') OR (CurrInputCh = '/')) AND Comment
  then
  begin
    Get(Sym);
    exit;
  ...
  begin
    ...
    case state of
      1:
        if ((CurrInputCh = '!') OR (CurrInputCh >= '#') AND (CurrInputCh <= '$')
          OR (CurrInputCh >= '0') AND (CurrInputCh <= '9') OR
          (CurrInputCh >= '@') AND (CurrInputCh <= 'Z') OR (CurrInputCh = '\')
          OR (CurrInputCh >= '^') AND (CurrInputCh <= '{') OR
          (CurrInputCh >= '}')) then
        begin
      ...
      4:
        if ((CurrInputCh <= CHR(12)) OR (CurrInputCh >= CHR(14)) AND
          (CurrInputCh <= '&') OR (CurrInputCh >= '(')) then
        begin
...
begin
  case ErrorCode of
    0:
      Result := 'EOF expected';
    1:
      Result := 'ident expected';
    2:
      Result := 'integer_ expected';
    3:
      Result := 'float expected';
    4:
      Result := 'SQLString expected';
    5:
      Result := 'SQLNameString expected';
    6:
      Result := '"NOINDEX" expected';
    7:
      Result := '"NOREDUCE" expected';
    8:
      Result := '";" expected';
    9:
      Result := '"SELECT" expected';
    10:
      Result := '"ALL" expected';
    11:
      Result := '"DISTINCT" expected';
    12:
    ...
    15:
      Result := '"BY" expected';
    16:
      Result := '"HAVING" expected';
    17:
      Result := '"ORDER" expected';
    18:
      Result := '"INSERT" expected';
    19:
      Result := '"INTO" expected';
    20:
    ...
    23:
      Result := '")" expected';
    24:
      Result := '"CROSS" expected';
    25:
      Result := '"JOIN" expected';
    26:
      Result := '"NATURAL" expected';
    27:
      Result := '"INNER" expected';
    28:
      Result := '"LEFT" expected';
    29:
      Result := '"OUTER" expected';
    30:
      Result := '"RIGHT" expected';
    31:
      Result := '"FULL" expected';
    32:
      Result := '"UNION" expected';
    33:
      Result := '"ON" expected';
    34:
      Result := '"USING" expected';
    35:
      Result := '"," expected';
    36:
    ...
    68:
      Result := '"BETWEEN" expected';
    69:
      Result := '"LIKE" expected';
    70:
      Result := '"ESCAPE" expected';
    71:
      Result := '"IGNORE" expected';
    72:
    ...
    79:
      Result := '"/" expected';
    80:
      Result := '"CHARACTER_LENGTH" expected';
    81:
      Result := '"CHAR_LENGTH" expected';
    82:
      Result := '"COALESCE" expected';
    83:
      Result := '"CURRENT_DATE" expected';
    84:
      Result := '"CURRENT_TIME" expected';
    85:
      Result := '"CURRENT_TIMESTAMP" expected';
    86:
      Result := '"CURRENT_USER" expected';
    87:
      Result := '"USER" expected';
    88:
      Result := '"LOWER" expected';
    89:
      Result := '"UPPER" expected';
    90:
      Result := '"POSITION" expected';
    91:
      Result := '"SESSION_USER" expected';
    92:
      Result := '"SUBSTRING" expected';
    93:
      Result := '"FOR" expected';
    94:
      Result := '"SYSTEM_USER" expected';
    95:
      Result := '"TRIM" expected';
    96:
      Result := '"LEADING" expected';
    97:
      Result := '"TRAILING" expected';
    98:
      Result := '"BOTH" expected';
    99:
      Result := '"EXTRACT" expected';
    100:
      Result := '"YEAR" expected';
    101:
      Result := '"MONTH" expected';
    102:
      Result := '"DAY" expected';
    103:
      Result := '"HOUR" expected';
    104:
      Result := '"MINUTE" expected';
    105:
      Result := '"SECOND" expected';
    106:
      Result := '"NULLIF" expected';
    107:
      Result := '"ABS" expected';
    108:
      Result := '"CEILING" expected';
    109:
    ...
    111:
      Result := '"LOG" expected';
    112:
      Result := '"POWER" expected';
    113:
      Result := '"RAND" expected';
    114:
    ...
    116:
      Result := '"END" expected';
    117:
      Result := '"WHEN" expected';
    118:
      Result := '"THEN" expected';
    119:
      Result := '"?" expected';
    120:
      Result := '"DATE" expected';
    121:
      Result := '"TIME" expected';
    122:
    ...
    125:
      Result := 'not expected';
    126:
      Result := 'invalid BooleanLiteral';
    127:
      Result := 'invalid IntervalLiteral';
    128:
      Result := 'invalid IntervalLiteral';
    129:
      Result := 'invalid WhenClause';
    130:
      Result := 'invalid CaseExpression';
    131:
      Result := 'invalid ScalarFunction';
    132:
      Result := 'invalid ScalarFunction';
    133:
      Result := 'invalid ScalarFunction';
    ...
    135:
      Result := 'invalid Factor';
    136:
      Result := 'invalid Factor';
    137:
      Result := 'invalid IsTest';
    138:
      Result := 'invalid InClause';
    139:
      Result := 'invalid AllOrAnyClause';
    140:
      Result := 'invalid CondPrimary';
    141:
      Result := 'invalid CondPrimary';
    142:
      Result := 'invalid CondPrimary';
    ...
    149:
      Result := 'invalid OrderItem';
    150:
      Result := 'invalid UpdateItem';
    151:
      Result := 'invalid ValueItem';
    152:
      Result := 'invalid NonJoinTablePrimary';
    153:
      Result := 'invalid JoinTableExp';
    154:
      Result := 'invalid SimpleTableRefOrParenTableExp';
    155:
      Result := 'invalid SQLName';
    156:
      Result := 'invalid InsertStatement';
    157:
      Result := 'invalid TableExp';
    158:
      Result := 'invalid FFSQL';

    200:
      Result := 'Text after end of valid sql statement';
    201:
      Result := 'Nested aggregates are not allowed';
    202:
      Result := 'Aggregates may not appear in a WHERE clause';
    203:
      Result := 'Reserved word (' + Data + ') not allowed';
...
procedure TFFSQL._SimpleAlias(var TableRef: TffSqlTableRef);
var
  aSQLName: String;
begin
...
procedure TFFSQL._BooleanLiteral(Parent: TFFSqlNode;
  var BooleanLiteral: TFFSqlBooleanLiteral);
begin
...
procedure TFFSQL._CaseExpression(Parent: TFFSqlNode;
  var CaseExp: TFFSqlCaseExpression);
var
  WhenClauseList: TFFSqlWhenClauseList;
var
  Exp: TFFSqlSimpleExpression;
begin
...
var
  Exp: TFFSqlSimpleExpression;
var
  CaseExp: TFFSqlCaseExpression;
var
  CoalesceExp: TFFSqlCoalesceExpression;
begin
  ...
  case fCurrentInputSymbol of
    ...
    CHARACTER_underscoreLENGTHSym, CHAR_underscoreLENGTHSym:
      begin
        if (fCurrentInputSymbol = CHARACTER_underscoreLENGTHSym) then
        begin
          Get;
        end
        else
    ...
    CURRENT_underscoreUSERSym, USERSym:
      begin
        if (fCurrentInputSymbol = CURRENT_underscoreUSERSym) then
        begin
          Get;
        end
        else
    ...
    TRIMSym:
      begin
        ...
        if (fCurrentInputSymbol = LEADINGSym) OR
          (fCurrentInputSymbol = TRAILINGSym) OR (fCurrentInputSymbol = BOTHSym)
        then
        begin
...
procedure TFFSQL._Param(Parent: TFFSqlNode; var Param: TFFSqlParam);
begin
  Param := TFFSqlParam.Create(Parent);
  Expect(_querySym);
end;

procedure TFFSQL._Literal(Parent: TFFSqlNode; var Literal: TFFSqlLiteral);
var
  FloatLiteral: TFFSqlFloatLiteral;
var
  IntegerLiteral: TFFSqlIntegerLiteral;
var
  StringLiteral: TFFSqlStringLiteral;
var
  DateLiteral: TFFSqlDateLiteral;
var
  TimeLiteral: TFFSqlTimeLiteral;
var
  TimestampLiteral: TFFSqlTimestampLiteral;
var
  IntervalLiteral: TFFSqlIntervalLiteral;
var
...
procedure TFFSQL._Factor(Parent: TFFSqlNode; var Factor: TFFSqlFactor;
  MulOp: TFFSqlMulOp);
var
...
begin
  ...
  case fCurrentInputSymbol of
    ...
    CASESym, CHARACTER_underscoreLENGTHSym, CHAR_underscoreLENGTHSym,
      COALESCESym, CURRENT_underscoreDATESym, CURRENT_underscoreTIMESym,
      CURRENT_underscoreTIMESTAMPSym, CURRENT_underscoreUSERSym, USERSym,
      LOWERSym, UPPERSym, POSITIONSym, SESSION_underscoreUSERSym, SUBSTRINGSym,
      SYSTEM_underscoreUSERSym, TRIMSym, EXTRACTSym, NULLIFSym, ABSSym,
      CEILINGSym, FLOORSym, EXPSym, LOGSym, POWERSym, RANDSym, ROUNDSym:
      begin
...
procedure TFFSQL._Term(Parent: TFFSqlNode; var Term: TFFSqlTerm;
  AddOp: TFFSqlAddOp);
var
  Factor: TFFSqlFactor;
var
...
begin
  ...
  while (fCurrentInputSymbol = _starSym) OR (fCurrentInputSymbol = _slashSym) do
  begin
...
procedure TFFSQL._SimpleExpressionList(Parent: TFFSqlNode;
  var SimpleExpressionList: TFFSqlSimpleExpressionList);
var
  SimpleExpression: TFFSqlSimpleExpression;
begin
...
procedure TFFSQL._IsTest(Parent: TFFSqlNode; var IsTest: TFFSqlIsTest);
begin
  Expect(ISSym);
...
begin
  ...
  if (fCurrentInputSymbol = FULLSym) OR (fCurrentInputSymbol = PARTIALSym) then
  begin
...
procedure TFFSQL._InClause(Parent: TFFSqlNode; var InClause: TFFSqlInClause;
  Negated: boolean);
var
  SimpleExpressionList: TFFSqlSimpleExpressionList;
var
  Select: TFFSqlSELECT;
begin
...
procedure TFFSQL._LikeClause(Parent: TFFSqlNode;
  var LikeClause: TFFSqlLikeClause; Negated: boolean);
var
  SimpleExpression: TFFSqlSimpleExpression;
begin
...
var
  RelOp: TFFSqlRelop;
var
  BetweenClause: TFFSqlBetweenClause;
var
  LikeClause: TFFSqlLikeClause;
var
  InClause: TFFSqlInClause;
var
  IsTest: TFFSqlIsTest;
var
  AllOrAny: TFFSqlAllOrAnyClause;
var
  ExistsClause: TFFSqlExistsClause;
var
  UniqueClause: TFFSqlUniqueClause;
var
  MatchClause: TFFSqlMatchClause;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        case fCurrentInputSymbol of
          _equalSym, _less_equalSym, _lessSym, _greaterSym, _greater_equalSym,
            _less_greaterSym:
            begin
              case fCurrentInputSymbol of
                _equalSym:
              ...
              if (fCurrentInputSymbol = ALLSym) OR
                (fCurrentInputSymbol = ANYSym) OR (fCurrentInputSymbol = SOMESym)
              then
              begin
...
procedure TFFSQL._CondTerm(Parent: TFFSqlNode; var CondTerm: TFFSqlCondTerm);
var
  CondFactor: TFFSqlCondFactor;
begin
...
procedure TFFSQL._GroupColumn(Parent: TFFSqlNode; var Col: TFFSqlGroupColumn);
var
  aSQLName: String;
begin
...
procedure TFFSQL._FieldRef(Parent: TFFSqlNode; var FieldRef: TFFSqlFieldRef);
var
  aSQLName: String;
begin
...
procedure TFFSQL._Aggregate(Parent: TFFSqlNode; var Aggregate: TFFSqlAggregate);
var
  SimpleExpression: TFFSqlSimpleExpression;
begin
  ...
  begin
    ...
    begin
      if (fCurrentInputSymbol = ALLSym) OR (fCurrentInputSymbol = DISTINCTSym)
      then
      begin
        if (fCurrentInputSymbol = ALLSym) then
        begin
  ...
  else if (fCurrentInputSymbol = MINSym) OR (fCurrentInputSymbol = MAXSym) OR
    (fCurrentInputSymbol = SUMSym) OR (fCurrentInputSymbol = AVGSym) then
  begin
...
procedure TFFSQL._Column(Parent: TFFSqlNode; var Col: TFFSqlColumn);
var
  ColumnName: String;
begin
...
procedure TFFSQL._ColumnAlias(var Selection: TFFSqlSelection);
var
  Col: TFFSqlColumn;
begin
  if (fCurrentInputSymbol = ASSym) then
...
procedure TFFSQL._Selection(SelectionList: TFFSqlSelectionList);
var
...
begin
  ...
  begin
    ...
    Selection.SimpleExpression := Exp;
    if (fCurrentInputSymbol = identSym) OR
      (fCurrentInputSymbol = SQLNameStringSym) OR (fCurrentInputSymbol = ASSym)
    then
    begin
...
procedure TFFSQL._OrderColumn(Parent: TFFSqlNode; var Col: TFFSqlOrderColumn);
var
  aSQLName: String;
begin
...
procedure TFFSQL._OrderItem(Parent: TFFSqlNode; var OrderItem: TFFSqlOrderItem);
var
  OrderColumn: TFFSqlOrderColumn;
begin
  ...
  if (fCurrentInputSymbol = ASCSym) OR (fCurrentInputSymbol = DESCSym) then
  begin
...
var
  Simplex: TFFSqlSimpleExpression;
var
  aSQLName: String;
begin
...
procedure TFFSQL._SimpleTableRef(Parent: TFFSqlNode;
  var TableRef: TffSqlTableRef);
var
  aSQLName: String;
begin
...
begin
  ...
  while (fCurrentInputSymbol = _plusSym) OR (fCurrentInputSymbol = _minusSym) OR
...
procedure TFFSQL._ValueItem(Parent: TFFSqlNode; var ValueItem: TFFSqlValueItem);
var
  Simplex: TFFSqlSimpleExpression;
begin
...
procedure TFFSQL._ValueList(Parent: TFFSqlNode; var ValueList: TFFSqlValueList);
var
  ValueItem: TFFSqlValueItem;
begin
...
procedure TFFSQL._TableConstructor(Parent: TFFSqlNode;
  var ValueList: TFFSqlValueList);
begin
  Expect(VALUESSym);
  Expect(_lparenSym);
...
procedure TFFSQL._NonJoinTablePrimary(Parent: TFFSqlNode;
  var NonJoinTablePrimary: TffSqlNonJoinTablePrimary);
var
  ValueList: TFFSqlValueList;
var
  NonJoinTableExp: TffSqlNonJoinTableExp;
var
  TableRef: TffSqlTableRef;
var
  SelectSt: TFFSqlSELECT;
begin
...
procedure TFFSQL._NonJoinTableTerm(Parent: TFFSqlNode;
  var NonJoinTableTerm: TffSqlNonJoinTableTerm);
var
  NonJoinTablePrimary: TffSqlNonJoinTablePrimary;
begin
...
procedure TFFSQL._UsingItem(Parent: TFFSqlNode; var UsingItem: TFFSqlUsingItem);
var
  aSQLName: String;
begin
...
procedure TFFSQL._UsingList(Parent: TFFSqlNode; var UsingList: TFFSqlUsingList);
var
  UsingItem: TFFSqlUsingItem;
begin
...
procedure TFFSQL._TableRef(Parent: TFFSqlNode; var TableRef: TffSqlTableRef);
var
  aSQLName: String;
var
  TableExp: TffSqlTableExp;
var
  ColumnList: TFFSqlInsertColumnList;
begin
  TableRef := TffSqlTableRef.Create(Parent);
  if IsTableExp then
  begin
...
procedure TFFSQL._NonJoinTableExp(Parent: TFFSqlNode;
  var NonJoinTableExp: TffSqlNonJoinTableExp);
var
  NonJoinTableTerm: TffSqlNonJoinTableTerm;
begin
...
procedure TFFSQL._JoinTableExp(Parent: TFFSqlNode;
  const JoinTableExp: TffSqlJoinTableExp);
var
  TableRef: TffSqlTableRef;
var
...
begin
  ...
  begin
    ...
    if (fCurrentInputSymbol = INNERSym) OR (fCurrentInputSymbol = LEFTSym) OR
      (fCurrentInputSymbol = RIGHTSym) OR (fCurrentInputSymbol = FULLSym) OR
    ...
    JoinTableExp.TableRef2 := TableRef;
    if (fCurrentInputSymbol = ONSym) OR (fCurrentInputSymbol = USINGSym) then
    begin
...
procedure TFFSQL._SimpleTableRefOrParenTableExp(Parent: TFFSqlNode;
  var TableRef: TffSqlTableRef);
var
  TableExp: TffSqlTableExp;
var
...
procedure TFFSQL._SQLName(var aName: String);
begin
...
procedure TFFSQL._OrderList(Parent: TFFSqlNode; var OrderList: TFFSqlOrderList);
var
  OrderItem: TFFSqlOrderItem;
begin
...
procedure TFFSQL._CondExp(Parent: TFFSqlNode; var CondExp: TFFSqlCondExp);
var
...
procedure TFFSQL._SelectionList(Parent: TFFSqlSELECT;
  var SelectionList: TFFSqlSelectionList);
begin
...
procedure TFFSQL._SelectStatement(Parent: TFFSqlNode; var Select: TFFSqlSELECT);
var
  SelectionList: TFFSqlSelectionList;
var
  CondExp: TFFSqlCondExp;
var
  GroupColumnList: TFFSqlGroupColumnList;
var
  TableRefList: TFFSqlTableRefList;
var
  OrderList: TFFSqlOrderList;
begin
  Expect(SELECTSym);
  Select := TFFSqlSELECT.Create(Parent);
  if (fCurrentInputSymbol = ALLSym) OR (fCurrentInputSymbol = DISTINCTSym) then
  begin
    if (fCurrentInputSymbol = ALLSym) then
    begin
      Get;
...
var
  aSQLName: String;
var
  InsertColumnList: TFFSqlInsertColumnList;
var
  TableExp: TffSqlTableExp;
...
begin
  ...
  else if (fCurrentInputSymbol = SELECTSym) OR (fCurrentInputSymbol = VALUESSym)
    OR (fCurrentInputSymbol = _lparenSym) OR (fCurrentInputSymbol = TABLESym)
  then
  begin
    _TableExp(InsertSt, TableExp);
    InsertSt.TableExp := TableExp;
...
procedure TFFSQL._TableExp(Parent: TFFSqlNode; var TableExp: TffSqlTableExp);
var
  NestedTableExp: TffSqlTableExp;
var
  JoinTableExp: TffSqlJoinTableExp;
var
  TmpJoinTableExp: TffSqlJoinTableExp;
var
  TmpTableExp: TffSqlTableExp;
var
  TableRef, TmpTableRef: TffSqlTableRef;
var
  NonJoinTableExp: TffSqlNonJoinTableExp;
begin
  ...
  begin
    ...
    OR (fCurrentInputSymbol = TABLESym) then
  begin
...
var
  TableExp: TffSqlTableExp;
var
  InsertSt: TFFSqlINSERT;
var
  UpdateSt: TFFSqlUPDATE;
var
  DeleteSt: TFFSqlDELETE;
...
begin
  Result := 'Comment: ' + #13#10 + 'Author: ' + #13#10 + 'Copyright: ';
end;
...
begin
  ...
  symSet[1, 5] := [CHARACTER_underscoreLENGTHSym - 80, CHAR_underscoreLENGTHSym
    - 80, COALESCESym - 80, CURRENT_underscoreDATESym - 80,
    CURRENT_underscoreTIMESym - 80, CURRENT_underscoreTIMESTAMPSym - 80,
    CURRENT_underscoreUSERSym - 80, USERSym - 80, LOWERSym - 80, UPPERSym - 80,
    POSITIONSym - 80, SESSION_underscoreUSERSym - 80, SUBSTRINGSym - 80,
    SYSTEM_underscoreUSERSym - 80, TRIMSym - 80];
  symSet[1, 6] := [EXTRACTSym - 96, NULLIFSym - 96, ABSSym - 96,
    CEILINGSym - 96, FLOORSym - 96, EXPSym - 96, LOGSym - 96];
  symSet[1, 7] := [POWERSym - 112, RANDSym - 112, ROUNDSym - 112,
    _querySym - 112, DATESym - 112, TIMESym - 112, TIMESTAMPSym - 112,
    INTERVALSym - 112];
  symSet[2, 0] := [identSym, integer_Sym, floatSym, SQLStringSym,
    SQLNameStringSym];
  symSet[2, 1] := [_lparenSym - 16];
  symSet[2, 2] := [COUNTSym - 32];
  symSet[2, 3] := [MINSym - 48, MAXSym - 48, SUMSym - 48, AVGSym - 48,
    NOTSym - 48, EXISTSSym - 48, UNIQUESym - 48];
  symSet[2, 4] := [TRUESym - 64, FALSESym - 64, CASESym - 64, _minusSym - 64];
  symSet[2, 5] := [CHARACTER_underscoreLENGTHSym - 80, CHAR_underscoreLENGTHSym
    - 80, COALESCESym - 80, CURRENT_underscoreDATESym - 80,
    CURRENT_underscoreTIMESym - 80, CURRENT_underscoreTIMESTAMPSym - 80,
    CURRENT_underscoreUSERSym - 80, USERSym - 80, LOWERSym - 80, UPPERSym - 80,
    POSITIONSym - 80, SESSION_underscoreUSERSym - 80, SUBSTRINGSym - 80,
    SYSTEM_underscoreUSERSym - 80, TRIMSym - 80];
  symSet[2, 6] := [EXTRACTSym - 96, NULLIFSym - 96, ABSSym - 96,
    CEILINGSym - 96, FLOORSym - 96, EXPSym - 96, LOGSym - 96];
  symSet[2, 7] := [POWERSym - 112, RANDSym - 112, ROUNDSym - 112,
    _querySym - 112, DATESym - 112, TIMESym - 112, TIMESTAMPSym - 112,
    INTERVALSym - 112];
  symSet[3, 0] := [];
  symSet[3, 1] := [];
  symSet[3, 2] := [_equalSym - 32];
  symSet[3, 3] := [NOTSym - 48, _less_equalSym - 48, _lessSym - 48,
    _greaterSym - 48, _greater_equalSym - 48, _less_greaterSym - 48];
  symSet[3, 4] := [ISSym - 64, BETWEENSym - 64, LIKESym - 64, INSym - 64,
    MATCHSym - 64];
  symSet[3, 5] := [];
  symSet[3, 6] := [];
  symSet[3, 7] := [];
  ...
  symSet[4, 3] := [NOTSym - 48, _less_equalSym - 48, _lessSym - 48,
    _greaterSym - 48, _greater_equalSym - 48, _less_greaterSym - 48];
  ...
  symSet[5, 5] := [CHARACTER_underscoreLENGTHSym - 80, CHAR_underscoreLENGTHSym
    - 80, COALESCESym - 80, CURRENT_underscoreDATESym - 80,
    CURRENT_underscoreTIMESym - 80, CURRENT_underscoreTIMESTAMPSym - 80,
    CURRENT_underscoreUSERSym - 80, USERSym - 80, LOWERSym - 80, UPPERSym - 80,
    POSITIONSym - 80, SESSION_underscoreUSERSym - 80, SUBSTRINGSym - 80,
    SYSTEM_underscoreUSERSym - 80, TRIMSym - 80];
  symSet[5, 6] := [EXTRACTSym - 96, NULLIFSym - 96, ABSSym - 96,
    CEILINGSym - 96, FLOORSym - 96, EXPSym - 96, LOGSym - 96];
  symSet[5, 7] := [POWERSym - 112, RANDSym - 112, ROUNDSym - 112,
    _querySym - 112, DATESym - 112, TIMESym - 112, TIMESTAMPSym - 112,
    INTERVALSym - 112];
  symSet[6, 0] := [];
